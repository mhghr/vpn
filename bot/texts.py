...
# Main messages
WELCOME_MESSAGE = """🌐 سلام دوست خوبم! به ربات چابک خوش اومدی 🚀
 با این ربات می‌تونی به اینترنت آزاد با سرعت و امنیت بالا متصل بشی:
• 🔥 مناسب برای گیمرها ، تریدرها ، کاربران هوش مصنوعی 
